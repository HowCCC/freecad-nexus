...
from freecad_nexus.tools.documents import register_document_tools
from freecad_nexus.tools.draft import register_draft_tools
from freecad_nexus.tools.execution import register_execution_tools
from freecad_nexus.tools.export import register_export_tools
from freecad_nexus.tools.macros import register_macro_tools
from freecad_nexus.tools.objects import register_object_tools
from freecad_nexus.tools.partdesign import register_partdesign_tools
from freecad_nexus.tools.spreadsheet import register_spreadsheet_tools
from freecad_nexus.tools.validation import register_validation_tools
from freecad_nexus.tools.view import register_view_tools
from freecad_nexus.tools.surface import register_surface_tools
from freecad_nexus.tools.assembly import register_assembly_tools
from freecad_nexus.tools.cam import register_cam_tools
...
def register_all_tools(mcp: Any, get_bridge_func: Callable[[], Awaitable[Any]]) -> None:
    """Register all FreeCAD tools with the FreeCAD Nexus.

    Args:
        mcp: The FastMCP (FreeCAD Nexus) instance (Any due to lack of stubs).
    ...
    register_surface_tools(mcp, get_bridge_func)
